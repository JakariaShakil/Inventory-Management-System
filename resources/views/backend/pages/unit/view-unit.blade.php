        ...
        <div class="card col-md-12 shadow-base bd-0 mg-t-20 widget-4">
            <div class="card-header">
                <div class="hidden-xs-down">
                    <h2 class="text-secondary">Units List</h2>
                </div>
                <div class="tx-24 hidden-xss-down">
                    <a href="{{ route('units.add') }}" class="btn btn-info btn-sm float-right text-white"><i
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <form id="delete-form-{{ $unit->id }}" action="{{ route('units.delete', $unit->id) }}" method="post"
                            style="display:none;">
                          @csrf
                          @method('DELETE')
