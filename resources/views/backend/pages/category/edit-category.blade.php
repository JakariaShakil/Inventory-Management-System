  ...
  <div class="br-pagebody">
    <div class="row row-sm">
        <div class="card col-md-12 shadow-base bd-0 mg-t-20 widget-4">
            ...
            <form action="{{ route('categories.update',$allCategoryData->id) }}" method="POST" id="form"  enctype="multipart/form-data">
                @csrf
                    ...
                    <div  class="row mg-b-25">
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" name="name" value="{{  $allCategoryData->name }}"   >
